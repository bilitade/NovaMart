...
# FOUNDATION MODELS
# ─────────────────────────────────────────────
# Orchestrator agent: OpenAI gpt-oss-20b - fast, cost-efficient routing decisions
# (Claude Haiku 4.5 unavailable - Anthropic models geo-blocked on this account)
ORCHESTRATOR_MODEL_ID = "openai.gpt-oss-20b-1:0"

# Worker agents: OpenAI gpt-oss-120b - more capable for reasoning and generation
# (Claude Sonnet 4.5 unavailable - Anthropic models geo-blocked on this account)
